...
def calcular_peso(objeto):
    tamano_total = sys.getsizeof(objeto)
        
    # Si el objeto es un diccionario, lista, tupla o conjunto, iteramos sobre sus elementos
    if isinstance(objeto, dict):
        tamano_total += sum(sys.getsizeof(k) + sys.getsizeof(v) for k, v in objeto.items())
    elif isinstance(objeto, (list, tuple, set)):
        tamano_total += sum(sys.getsizeof(item) for item in objeto)
...
class OpenElevationServicer(openelevation_pb2_grpc.OpenElevationServicer):
 ...
 ##End-Modified AAOR code for AreaPointsElevation function
    ...
    ###Start-Analisis Hanlin code - sin min_height, max_height y avg_height for the AreaRangesElevation function
    # @handle_exceptions
    # def AreaRangesElevation(self, request, context):
    #     geom = convert.polygon_to_geometry(self._format_area_request(request))
    #     collection_queried = querybuilder.polygon_coloring_elevation_based_hanli_sin_min_max_avg(geom, 'srtm')

    #     #print("collection_queried_aqui",collection_queried[0])
    #     print("polygon_coloring_elevation_based_hanli_sin_min_max_avg")
    #     result = []
    #     for feature in collection_queried[0]['features']:
    #         heightBase = int(feature['properties']['height'])
    #         if feature['geometry']['type'] == 'Polygon':
    #             result.append(defs.UnitedArea(
    #                 baseElevation=heightBase,
   ...
   ###End-Analisis Hanlin code - sin min_height, max_height y avg_height for the AreaRangesElevation function

    #####---->    (4)   ######

    ###Start-Analisis Hanlin code - optimizado AAOR for the AreaRangesElevation function
    # @handle_exceptions
    # def AreaRangesElevation(self, request, context):
    #     geom = convert.polygon_to_geometry(self._format_area_request(request))
    #     collection_queried = querybuilder.polygon_coloring_elevation_based_hanli_optimizado_aaor(geom, 'srtm')

    #     #print("collection_queried_aqui",collection_queried[0])
    #     print("polygon_coloring_elevation_based_hanli_optimizado_aaor")
    #     result = []
    #     for feature in collection_queried[0]['features']:
    #         heightBase = int(feature['properties']['height'])
    #         if feature['geometry']['type'] == 'Polygon':
   ...
   ###End-Analisis Hanlin code - optimizado AAOR for the AreaRangesElevation function
   ...
   #####---->    (5)   ###### h1_paralelizacion
    ...
    # def AreaRangesElevation(self, request, context):
    #     geom = convert.polygon_to_geometry(self._format_area_request(request))
    #     collection_queried, range_queried, avg_queried = querybuilder.polygon_coloring_elevation_based_hanli_1_paralelizacion(geom, 'srtm')
        
    #     #print("collection_queried",collection_queried)
    #     print("polygon_coloring_elevation_based_hanli_1_paralelizacion")
    #     result = []
    #     for feature in collection_queried['features']:
    #         heightBase = int(feature['properties']['height'])
    #         if feature['geometry']['type'] == 'Polygon':
...
#####---->    (6)   ###### paralelizacion_1_2

    ###Start-Analisis adaptación Hanlin code for the AreaRangesElevation function
    # @handle_exceptions
    # def AreaRangesElevation(self, request, context):
    #     geom = convert.polygon_to_geometry(self._format_area_request(request))
    #     collection_queried, range_queried, avg_queried = querybuilder.polygon_coloring_elevation_based_hanli_1_paralelizacion_1_2(geom, 'srtm')
        
    #     #print("collection_queried",collection_queried)
    #     print("polygon_coloring_elevation_based_hanli_1_paralelizacion_1")
    #     result = []
    #     for feature in collection_queried['features']:
    #         heightBase = int(feature['properties']['height'])
    #         if feature['geometry']['type'] == 'Polygon':
    ...
    #####---->    (7)   ###### prueba paralelización

    ###Start-Analisis adaptación Hanlin code for the AreaRangesElevation function
    # @handle_exceptions
    # def AreaRangesElevation(self, request, context):
    #     geom = convert.polygon_to_geometry(self._format_area_request(request))
    #     collection_queried, range_queried, avg_queried = querybuilder.polygon_coloring_elevation_prueba_paralelizacion(geom, 'srtm')
        
    #     #print("collection_queried",collection_queried)
    #     print("polygon_coloring_elevation_based_hanli_1_prueba_paralelizacion(7)")
    #     result = []
    #     for feature in collection_queried['features']:
    #         heightBase = int(feature['properties']['height'])
    #         if feature['geometry']['type'] == 'Polygon':
    ...
    def AreaRangesElevation(self, request, context):
        ...
        tamano_en_megas = calcular_peso(collection_queried)
        print(f"El tamaño de la colección en memoria es: {tamano_en_megas:.2f} MB")
