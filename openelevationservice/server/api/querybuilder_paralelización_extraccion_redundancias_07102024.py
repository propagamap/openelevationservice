...
def polygon_coloring_elevation_modified_cmt(geometry, dataset):
    ...
    if geometry.geom_type == 'Polygon':
        ...
        #     val1 = parts[1]    # Valor en la posición 1
        ...
        ####Codigo de extracción 1

        # # Lista para almacenar las tuplas (val1, val3, val4) y los píxeles originales sin duplicados
        # extracted_values = []
        # new_result_pixels = []
        ...
        #         # Añadir el pixel completo a la lista sin duplicados
        #         new_result_pixels.append(pixel)

        # # Imprimir el nuevo result_pixels sin duplicados
        # for pixel in new_result_pixels:
        #     print(pixel)

        ####Codigo de extracción 2
        ...
        #     # Extraer los valores 1, 3 y 4 (índices 1, 2 y 3)
        #     val1 = parts[1]    # Valor en la posición 1 (WKT text)
        ...
        #         formatted_pixel = (f"({parts[0]},{val1},{val3},{val4})",)
        #         new_result_pixels.append(formatted_pixel)

        # # Imprimir el nuevo result_pixels sin duplicados y con el formato correcto
        # for pixel in new_result_pixels:
        #     print(pixel)

        ####Codigo de extracción 3
